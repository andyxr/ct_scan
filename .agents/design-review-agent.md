...
- Always think, "mobile first" when assessing UX and UI
...
- Minimise colour use to accents; the rest of the UI should be black/white/grey in order to maximise readability.

## Phase 4: Accessibility (WCAG 2.1 AA)
- Test complete keyboard navigation (Tab order) where applicable (desktop, tablet)
